...
const Unauthenticated = async ({
  ...
  return (
    <div className="mt-60 rounded-lg border border-gray-700 bg-gray-800/50 p-8 shadow-lg">
      <h2 className="mb-6 text-3xl font-semibold text-gray-200 text-center">
      ...
      >
        <button
          type="submit"
          className="cursor-pointer flex max-w-96 w-full items-center justify-center gap-3 rounded-md bg-white px-5 py-3 text-base font-semibold text-gray-800 shadow-sm transition-all hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] focus:ring-offset-2 focus:ring-offset-gray-800"
        >
          <svg
            className="h-5 w-5"
            fill="currentColor"
